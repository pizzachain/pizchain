...
foreach(ADDITIONAL_PLUGIN_SOURCE_DIR ${PIZ_ADDITIONAL_PLUGINS})
...
foreach(ADDITIONAL_PLUGIN_TARGET ${ADDITIONAL_PLUGINS_TARGET})
    target_link_libraries( nodepiz PRIVATE -Wl,${whole_archive_flag} ${ADDITIONAL_PLUGIN_TARGET} -Wl,${no_whole_archive_flag} )
endforeach()
