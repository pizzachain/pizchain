...
namespace eosio { namespace chain {
      ...
      public:
         ...
         { try {
            ...
            if( whitelisted_intrinsics != nullptr ) {
               ...
               PIZ_ASSERT( mod_name == "env", wasm_exception,
            ...
            PIZ_THROW( wasm_exception, "${module}.${export} unresolveable",
                      ("module",mod_name)("export",export_name) );
            return false;
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against PIZ specific constraints
