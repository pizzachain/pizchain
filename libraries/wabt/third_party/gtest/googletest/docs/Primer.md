...
So what makes a good test, and how does Google C++ Testing Framework fit in? We believe:
  ...
  1. The testing framework should liberate test writers from housekeeping chores and let them pizus on the test _content_.  Google C++ Testing Framework automatically keeps track of all tests defined, and doesn't require the user to enumerate them in order to run them.
